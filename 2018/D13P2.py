#Started 24/02/2021 00:43
#Ended 24/02/2021 01:22
...
class Cart:
	...
	def __gt__(self, cart2):
		if self.xy[1] == cart2.xy[1]:
			return self.xy[0] > cart2.xy[0]
		else:
			return self.xy[1] > cart2.xy[1]
...
def detect_collision():
	...
	for cart in carts:
		...
		if xy in coordinates:
			carts = list(filter(lambda cart: list(cart.xy) != xy, carts))
			return True
		else:
